...
This is a project-level Claude Skill. From this `SKILL.md`, the design specification is located at `../../../ant-design-system-prompt.md`.
...
9. Detail page constraints
10. Form modal constraints (`Modal` + `Form`, Basic Form) in `../../../templates/form-modal.md`
11. Page generation technical rules (interactive + Tailwind auxiliary) in `../../../rules/interaction.md`
